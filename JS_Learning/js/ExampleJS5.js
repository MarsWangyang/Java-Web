...
function addFruit() {
    ...
    var fcount = parseInt($("fconut").value);
    var rowTotal = price * fcount;
    ...
    var rowTotalTD = tr.insertCell();
    rowTotal.innerText = rowTotal;

    var imgTD = tr.insertCell();
    imgTD.innerHTML = "<img src='../HTML_Learning/imgs/del.png' class='delImg'/>";
